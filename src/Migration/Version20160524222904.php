 ...
 */
class Version20160524222904 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project ADD COLUMN configHash VARCHAR(140) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX project_name_constraint');
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, name, status, created_at, modified_at FROM project');
        ...
        $this->addSql('INSERT INTO project (id, name, status, created_at, modified_at) SELECT id, name, status, created_at, modified_at FROM __temp__project');
